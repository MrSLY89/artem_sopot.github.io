!function (t, e) {
    ...
    var Jt = /^(none|table(?!-c[ea]).+)/, te = {position: "absolute", visibility: "hidden", display: "block"},
        ee = {letterSpacing: "0", fontWeight: "400"}, ie = ["Webkit", "O", "Moz", "ms"],
    ...
    ot.Animation = ot.extend(F, {
        ...
        fadeTo: function (t, e, i, n) {
            ...
            return t !== !1 && (t = t || "fx"), this.each(function () {
                var e, i = Ct.get(this), n = i[t + "queue"], r = i[t + "queueHooks"], o = ot.timers,
                    s = n ? n.length : 0;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (t, e, i) {
        ...
        return u.constructor = n, u.kill()._gc = !1, n.version = "1.19.0", u.invalidate = function () {
            ...
            i = i || {};
            var n, r, o, s = {ease: h, useFrames: this.usesFrames(), immediateRender: !1},
            ...
            var n, o, l, h, u, c, f, d, p = this._dirty ? this.totalDuration() : this._totalDuration,
                ...
                b = this._rawPrevTime, T = this._paused, x = this._cycle;
            ...
            if (this._cycle !== x && !this._locked) {
                var w = this._yoyo && 0 !== (1 & x), E = w === (this._yoyo && 0 !== (1 & this._cycle)),
                    C = this._totalTime, S = this._cycle, A = this._rawPrevTime, I = this._time;
        ...
        var t = 180 / Math.PI, e = [], i = [], n = [], r = {}, o = _gsScope._gsDefine.globals,
            ...
            l = function (t, e, i, n) {
                var r = {a: t}, o = {}, s = {}, a = {c: n}, l = (t + e) / 2, h = (e + i) / 2, u = (i + n) / 2,
        ...
        var u, c, f, d, p, m, g, v, y = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
            ...
            x = /(?:\d|\-|\+|=|#|\.)*/g, w = /opacity *= *([^)]*)/i, E = /opacity:([^;]*)/i,
            C = /alpha\(opacity *=.+?\)/i, S = /^(rgb|hsl)/, A = /([A-Z])/g, I = /-([a-z])/gi,
            D = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, P = function (t, e) {
                return e.toUpperCase()
        ...
        var Ct,
            ...
            kt = q.Transform = function () {
                ...
                if (f.svg = !(!t.getBBox || !jt(t)), f.svg && (Mt(t, Z(t, Dt, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), Ct = s.useSVGTransformAttr || Rt), o = Wt(t), o !== Ft) {
                    if (16 === o.length) {
                        var y, _, b, T, x, w = o[0], E = o[1], C = o[2], S = o[3], A = o[4], I = o[5], D = o[6], P = o[7],
                            k = o[8], O = o[9], L = o[10], N = o[12], R = o[13], M = o[14], j = o[11], F = Math.atan2(D, L);
                ...
                var e, i, n, r, o, s, a, l, h, u, c, f, p, m, g, v, y, _, b, T, x, w, E, C = this.data, S = this.t.style,
                    A = C.rotation, I = C.rotationX, D = C.rotationY, P = C.scaleX, k = C.scaleY, O = C.scaleZ, L = C.x,
                    N = C.y, R = C.z, z = C.svg, j = C.perspective, F = C.force3D;
    ...
    if (!n.TweenLite) {
        ...
        var N = [], R = {}, M = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, z = function (t) {
                ...
                var h, u, c = "get" === i ? t[e] : i, f = typeof t[e], d = "string" == typeof n && "=" === n.charAt(1),
                    p = {
                        t: t,
                        p: e,
                        s: c,
        ...
        s._init = function () {
            var t, e, i, n, r, o, s = this.vars, a = this._overwrittenProps, l = this._duration,
                h = !!s.immediateRender, u = s.ease;
            if (s.startAt) {
...
+function (t) {
    ...
    var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        var e = "modal", s = "4.0.0-alpha.5", a = "bs.modal", l = "." + a, h = ".data-api", u = t.fn[e], c = 300,
            f = 150, d = 27, p = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        ...
        var e = "tooltip", s = "4.0.0-alpha.5", a = "bs.tooltip", l = "." + a, h = t.fn[e], u = 150, c = "bs-tether",
            f = {
                animation: !0,
    ...
    !function (o) {
        var a = "popover", l = "4.0.0-alpha.5", h = "bs.popover", u = "." + h, c = o.fn[a],
            ...
            p = {FADE: "fade", ACTIVE: "active"}, m = {TITLE: ".popover-title", CONTENT: ".popover-content"}, g = {
                HIDE: "hide" + u,
                HIDDEN: "hidden" + u,
                SHOW: "show" + u,
                SHOWN: "shown" + u,
    ...
    m.prototype.css = function (e, i) {
        ...
        if (t.image.width && t.image.height) {
            var e = t.image.$container.getBoundingClientRect(), i = e.width, n = e.height, r = e.left,
                a = t.image.width, l = t.image.height, h = t.options.speed,
                u = "scroll" === t.options.type || "scroll-opacity" === t.options.type, c = 0, f = 0, d = n, p = 0,
                m = 0;
    ...
    function o(e) {
        if (r(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            var m = a.paddingLeft + a.paddingRight, g = a.paddingTop + a.paddingBottom,
                ...
                _ = a.borderLeftWidth + a.borderRightWidth, b = a.borderTopWidth + a.borderBottomWidth, T = u && s,
                x = t(o.width);
    ...
    return n.bindTap = function (t) {
        ...
        if (!this.isIgnoringMouseUp || "mouseup" != i.type) {
            var r = e.getPointerPoint(n), o = this.tapElement.getBoundingClientRect(), s = t.pageXOffset,
                a = t.pageYOffset,
    ...
    var yt = a(function (t, e, i) {
        ...
        wt = b(t, "PointerEvent") !== n, Et = xt && Tt.test(navigator.userAgent), Ct = "touch", St = "pen",
        At = "mouse", It = "kinect", Dt = 25, Pt = 1, kt = 2, Ot = 4, Lt = 8, Nt = 1, Rt = 2, Mt = 4, zt = 8, jt = 16,
        Ft = Rt | Mt, Wt = zt | jt, Ht = Ft | Wt, Bt = ["x", "y"], qt = ["clientX", "clientY"];
    w.prototype = {
        handler: function () {
        }, init: function () {
